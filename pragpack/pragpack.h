...
namespace prag
  ...
  */
  ...
  class MatMatMul
    {
    public:
      using value_type = typename ::prag::implementation_details::get_value_type<A>::value_type;
  ...
  class Diagonal
    ...
    public:
      ...
      Diagonal(const A& a, uint64_t rows, uint64_t cols) : _a(a), _rows(rows), _cols(cols), _evaluate_before_assigning(false)
        {
  ...
  class Block
    ...
    public:
      ...
      Block(const A& a, uint64_t pos_r, uint64_t pos_c, uint64_t rows, uint64_t cols, uint64_t a_rows, uint64_t a_cols) : _a(a), _pos_r(pos_r),
        _pos_c(pos_c), _rows(rows), _cols(cols), _a_rows(a_rows), _a_cols(a_cols), _evaluate_before_assigning(false)
        {
        _current_r = _pos_r;
        _current_c = _pos_c;
  ...
  class UnExprOp
    ...
    public:
      ...
      UnExprOp(const A& a, uint64_t rows, uint64_t cols) : _a(a), _rows(rows), _cols(cols), _evaluate_before_assigning(false)
        {
        }
  ...
  class matrix
    ...
    public:
      ...
      matrix(uint64_t rows, uint64_t cols) : _rows(rows), _cols(cols)
        {
        ::prag::implementation_details::resize<T, Container> r;
  ...
  Expr<
    ...
    OpAdd<T> > > operator + (const matrix<T, Container>& a, const matrix<T2, Container2>& b)
    {
    typedef BinExprOp<
      typename matrix<T, Container>::const_iterator,
      typename matrix<T2, Container2>::const_iterator,
  ...
  Expr<
    ...
    typename matrix<T, Container>::const_iterator,
    Expr<ExprOp>,
    OpAdd<T> > > operator + (const matrix<T, Container>& a, const Expr<ExprOp>& b)
    {
    typedef BinExprOp<
      typename matrix<T, Container>::const_iterator,
      Expr<ExprOp>,
  ...
  Expr<
    ...
    Expr<ExprOp>,
    typename matrix<T, Container>::const_iterator,
    OpAdd<T> > > operator + (const Expr<ExprOp>& a, const matrix<T, Container>& b)
    {
    typedef BinExprOp<
      Expr<ExprOp>,
      typename matrix<T, Container>::const_iterator,
  ...
  Expr<
    ...
    Expr<ExprOp1>,
    Expr<ExprOp2>,
    OpAdd<typename ExprOp1::value_type> > > operator + (const Expr<ExprOp1>& a, const Expr<ExprOp2>& b)
    {
    typedef BinExprOp<
      Expr<ExprOp1>,
      Expr<ExprOp2>,
  ...
  Expr<
    ...
    typename matrix<T, Container>::const_iterator,
    typename matrix<T2, Container2>::const_iterator,
    OpSub<T> > > operator - (const matrix<T, Container>& a, const matrix<T2, Container2>& b)
    {
    typedef BinExprOp<
      typename matrix<T, Container>::const_iterator,
      typename matrix<T2, Container2>::const_iterator,
  ...
  Expr<
    ...
    typename matrix<T, Container>::const_iterator,
    Expr<ExprOp>,
    OpSub<T> > > operator - (const matrix<T, Container>& a, const Expr<ExprOp>& b)
    {
    typedef BinExprOp<
      typename matrix<T, Container>::const_iterator,
      Expr<ExprOp>,
  ...
  Expr<
    ...
    Expr<ExprOp>,
    typename matrix<T, Container>::const_iterator,
    OpSub<T> > > operator - (const Expr<ExprOp>& a, const matrix<T, Container>& b)
    {
    typedef BinExprOp<
      Expr<ExprOp>,
      typename matrix<T, Container>::const_iterator,
  ...
  Expr<
    ...
    Expr<ExprOp1>,
    Expr<ExprOp2>,
    OpSub<typename ExprOp1::value_type> > > operator - (const Expr<ExprOp1>& a, const Expr<ExprOp2>& b)
    {
    typedef BinExprOp<
      Expr<ExprOp1>,
      Expr<ExprOp2>,
  ...
  Expr<
    ...
    typedef UnExprOp<
      typename matrix<T, Container>::const_iterator,
      OpNeg<T> > ExprT;
    return Expr<ExprT>(ExprT(a.begin(), a.rows(), a.cols()));
    }
  ...
  Expr<
    ...
    typename matrix<T, Container>::const_iterator,
    Constant<T>,
    OpMul<T> > > operator * (const matrix<T, Container>& a, T2 b)
    {
    typedef BinExprOp<
      typename matrix<T, Container>::const_iterator,
      Constant<T>,
  ...
  Expr<
    ...
    Constant<T>,
    typename matrix<T, Container>::const_iterator,
    OpMul<T> > > operator * (T2 a, const matrix<T, Container>& b)
    {
    typedef BinExprOp<
      Constant<T>,
      typename matrix<T, Container>::const_iterator,
  ...
  Expr<
    ...
    OpMul<typename ExprOp::value_type> > > operator * (const Expr<ExprOp>& a, T2 b)
    {
    typedef BinExprOp<
      Expr<ExprOp>,
      Constant<typename ExprOp::value_type>,
  ...
  Expr<
    ...
    Constant<typename ExprOp::value_type>,
    Expr<ExprOp>,
    OpMul<typename ExprOp::value_type> > > operator * (T2 a, const Expr<ExprOp>& b)
    {
    typedef BinExprOp<
      Constant<typename ExprOp::value_type>,
      Expr<ExprOp>,
  ...
  Expr<
    ...
    typename matrix<T, Container>::const_iterator,
    Constant<T>,
    OpDiv<T> > > operator / (const matrix<T, Container>& a, T2 b)
    {
    typedef BinExprOp<
      typename matrix<T, Container>::const_iterator,
      Constant<T>,
  ...
  Expr<
    ...
    Constant<T>,
    typename matrix<T, Container>::const_iterator,
    OpDiv<T> > > operator / (T2 a, const matrix<T, Container>& b)
    {
    typedef BinExprOp<
      Constant<T>,
      typename matrix<T, Container>::const_iterator,
  ...
  Expr<
    ...
    Expr<ExprOp>,
    Constant<typename ExprOp::value_type>,
    OpDiv<typename ExprOp::value_type> > > operator / (const Expr<ExprOp>& a, T2 b)
    {
    typedef BinExprOp<
      Expr<ExprOp>,
      Constant<typename ExprOp::value_type>,
  ...
  Expr<
    ...
    Constant<typename ExprOp::value_type>,
    Expr<ExprOp>,
    OpDiv<typename ExprOp::value_type> > > operator / (T2 a, const Expr<ExprOp>& b)
    {
    typedef BinExprOp<
      Constant<typename ExprOp::value_type>,
      Expr<ExprOp>,
  ...
  Expr<
    ...
    typename matrix<T, Container>::const_iterator,
    Constant<T>,
    OpAdd<T> > > operator + (const matrix<T, Container>& a, T2 b)
    {
    typedef BinExprOp<
      typename matrix<T, Container>::const_iterator,
      Constant<T>,
  ...
  Expr<
    ...
    Constant<T>,
    typename matrix<T, Container>::const_iterator,
    OpAdd<T> > > operator + (T2 a, const matrix<T, Container>& b)
    {
    typedef BinExprOp<
      Constant<T>,
      typename matrix<T, Container>::const_iterator,
  ...
  Expr<
    ...
    Expr<ExprOp>,
    Constant<typename ExprOp::value_type>,
    OpAdd<typename ExprOp::value_type> > > operator + (const Expr<ExprOp>& a, T2 b)
    {
    typedef BinExprOp<
      Expr<ExprOp>,
      Constant<typename ExprOp::value_type>,
      OpAdd<typename ExprOp::value_type> > ExprT;
    return Expr<ExprT>(ExprT(a, Constant<typename ExprOp::value_type>((typename ExprOp::value_type)b, a.rows(), a.cols()), a.rows(), a.cols(), a.evaluate_before_assigning()));
    }
  ...
  Expr<
    ...
    Constant<typename ExprOp::value_type>,
    Expr<ExprOp>,
    OpAdd<typename ExprOp::value_type> > > operator + (T2 a, const Expr<ExprOp>& b)
    {
    typedef BinExprOp<
      Constant<typename ExprOp::value_type>,
      Expr<ExprOp>,
  ...
  Expr<
    ...
    typename matrix<T, Container>::const_iterator,
    Constant<T>,
    OpSub<T> > > operator - (const matrix<T, Container>& a, T2 b)
    {
    typedef BinExprOp<
      typename matrix<T, Container>::const_iterator,
      Constant<T>,
  ...
  Expr<
    ...
    Constant<T>,
    typename matrix<T, Container>::const_iterator,
    OpSub<T> > > operator - (T2 a, const matrix<T, Container>& b)
    {
    typedef BinExprOp<
      Constant<T>,
      typename matrix<T, Container>::const_iterator,
  ...
  Expr<
    ...
    Expr<ExprOp>,
    Constant<typename ExprOp::value_type>,
    OpSub<typename ExprOp::value_type> > > operator - (const Expr<ExprOp>& a, T2 b)
    {
    typedef BinExprOp<
      Expr<ExprOp>,
      Constant<typename ExprOp::value_type>,
      OpSub<typename ExprOp::value_type> > ExprT;
    return Expr<ExprT>(ExprT(a, Constant<typename ExprOp::value_type>((typename ExprOp::value_type)b, a.rows(), a.cols()), a.rows(), a.cols(), a.evaluate_before_assigning()));
    }
  ...
  Expr<
    ...
    Constant<typename ExprOp::value_type>,
    Expr<ExprOp>,
    OpSub<typename ExprOp::value_type> > > operator - (T2 a, const Expr<ExprOp>& b)
    {
    typedef BinExprOp<
      Constant<typename ExprOp::value_type>,
      Expr<ExprOp>,
  ...
  Expr<
    ...
    return Expr<ExprT>(ExprT(a.begin(), i, j, rows, cols, a.rows(), a.cols()));
    }
  ...
  Expr<
    ...
    return Expr<ExprT>(ExprT(a, i, j, rows, cols, a.rows(), a.cols()));
    }
  ...
  bool svd(matrix<T, Container_mn>& a, matrix<T, Container_n>& w, matrix<T, Container_nn>& v)
    {
    using namespace ::prag::svd_details;
    auto m = a.rows();
    auto n = a.cols();
    w.resize(n, 1);
    v.resize(n, n);
  ...
  void cholesky(matrix<T, Container>& A)
    {
    assert(A.rows() == A.cols());
    using namespace ::prag::cholesky_details;
  ...
  void lmdif(bool(*f)(const matrix<T, Container_n>&, matrix<T, Container_m>&, void*), matrix<T, Container_n>& x, matrix<T, Container_m>& fvec, T ftol,
    ...
    for (;;)
      ...
      do {
        ...
        ::prag::lm_details::lmpar(fjac, ipvt, diag, qtf, delta, par, wa1, wa2);
        for (j = 0; j < n; ++j)
          {
          wa1(j) = -wa1(j);
          wa2(j) = x(j) + wa1(j);
